...
pub fn run() -> Result<(), Box<dyn error::Error>> {
    ...
    // In an effort to minimize the data on the heap, we're not
    // going to convert the entire contents into a data object.
    // We'll run our solution on each line as it's read
    println!("Final value: {}", calculator::find_common_characters_of_proper_box(contents));
